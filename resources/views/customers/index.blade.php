...
<div class="col-md">
    <div class="card">
        ...
        <div class="card-body">
            <table id="customersTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Email</th>
                ...
                <tbody>
                    @foreach ($customers as $customer)
                        <tr>
                            ...
                            <td>
                                <img src="{{ $customer->deposit_card ? $customer->deposit_card : asset('no_card.jpg') }}" width="50">
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('customers.destroy', $customer->id) }}" class="btn btn-danger delete-item">Delete</a>

                                <!-- Only show the 'View Rentals' button if the customer has rentals -->
                                @if($customer->hasRentals())
                                    <a href="{{ route('customers.rentalDetails', $customer->id) }}" class="btn btn-info">View Rentals</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
