        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addRow').addEventListener('click', function() {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="products[${rowIndex}][rental_start_date]" class="form-control rental-start-date" required>
                    </td>
                    <td>
                        <input type="text" name="products[${rowIndex}][rental_end_date]" class="form-control rental-end-date" required>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger remove-row">Remove</button>
                    </td>
            ...
            document.getElementById('itemsTable').addEventListener('input', function(e) {
                ...
                if (productSelect) {
                    ...
                    if (!isNaN(startDate) && !isNaN(endDate) && startDate <= endDate) {
                        ...
                        days = type === 'fixed' ? 1 : Math.floor(diffHours / 24) + (diffHours % 24 >= 12 ?
                            1 : 0);
                    }
            ...
            function initializeFlatpickr() {
                flatpickr('.rental-start-date, .rental-end-date', {
                    ...
                    onChange: function() {
                        ...
                        if (!isNaN(startDate) && !isNaN(endDate) && startDate <= endDate) {
                            const diffHours = Math.abs(endDate - startDate) / (1000 * 60 * 60);
                            days = Math.floor(diffHours / 24) + (diffHours % 24 >= 12 ? 1 : 0);
                        }
                        daysInput.value = days;
