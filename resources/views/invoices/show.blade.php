        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex mb-4">
                    <a class="btn btn-label-secondary d-grid w-100 me-4" target="_blank" href="{{ route('invoices.print', $invoice->id) }}">Print</a>
                    <a href="{{ route('invoices.edit', $invoice->id) }}" class="btn btn-label-secondary d-grid w-100">Edit</a>
                </div>
            </div>
        </div>
    </div>
